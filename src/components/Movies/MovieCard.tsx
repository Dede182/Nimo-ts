...
const MovieCard = ({ movie } : MovieProps) => {
  ...
  const percent = movie?.vote_average !== undefined
...
const SameMemoCard = ({movie : prevProps} : MovieProps , {movie : nextProps} : MovieProps) => {
        return Object.keys(prevProps).every((key) => {
            return prevProps[key as keyof movieType] === nextProps[key as keyof movieType]
        })
    }

const MemorizedMovieCard = React.memo(MovieCard, SameMemoCard)
